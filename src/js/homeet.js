document.addEventListener("DOMContentLoaded", function () {
  ...
  telegramInput.addEventListener("input", function () {
    ...
    placeholder.style.color = colorPlaceholder;
    var telegram_field = document.getElementById("inf_telegram");

    if(isTelegramValid.test(telegram)){
        telegram_field.innerHTML = telegram;
        telegram_field.style.background = "#ffffff";
        telegram_field.style.width = "auto";
    } else{
        telegram_field.innerHTML = "";
        telegram_field.style.background = "#f4f4f6";
        telegram_field.style.width = 25 + "%";
    } 
  ...
  document.getElementById("mainForm").addEventListener("submit", function (event) {
      ...
      var telegram = document.getElementById("name").value;
      var phone = document.getElementById("inpPhoneNumber").value;

      if (!isNameValid.test(name) || !isTelegramValid.test(telegram) || !isPhoneValid.test(phone) || textarea == "" || dateInput == "" || (isMale == "" && isFemale == "")) {
